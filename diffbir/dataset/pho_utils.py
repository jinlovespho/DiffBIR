            ...
            for img in imgs:
                ...
                for crop_id, crop_ann in img_ann.items():
                    for ann in crop_ann:
                        ...
                        # cv2.polylines(img0, [poly], True, (0,255,0), 2)
                        # cv2.putText(img0, text, (poly[0][0], poly[0][1]-5), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 1)
                        # cv2.imwrite('./tmp1.jpg', img0)
