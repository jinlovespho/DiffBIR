...
# STAGE2
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage2_swinCode_kernelOurs_ctrlV2_unetV2.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage2_swinCode_kernelOurs_ctrlV21_unetV21.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage2_swinReal_kernelOurs_ctrlV2_unetV2.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage2_swinReal_kernelOurs_ctrlV21_unetV21.sh 


# STAGE3 - 250512 추가
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage3_swinCode_kernelOurs_ctrlV2_unetV2.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage3_swinCode_kernelOurs_ctrlV21_unetV21.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage3_swinReal_kernelOurs_ctrlV2_unetV2.sh
bash run_script/train_script/run_train_diffbir_sam_cleaned_100k_ours_stage3_swinReal_kernelOurs_ctrlV21_unetV21.sh
